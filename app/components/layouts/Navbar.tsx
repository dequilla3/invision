...
export default function Navbar({ items }: NavbarProps) {
  ...
  return (
    <div className="shadow-md p-4 bg-teal-900">
        ...
        <nav className="flex ">
          <a href="#" className="text-xl">
            <div className="flex">
              ...
              <div className="text-white">InVision IBS</div>
            </div>
          </a>
          <ul className="flex ml-10">
            {navLinks.map((val, index) => (
              <li
                key={index}
                className={`ml-10 cursor-pointer transition-all duration-300 hover:border-b-2 hover:border-green-700 origin-center text-white ${
